...
export default function HomeSection() {
	return (
		<motion.section
			...
			className='w-full min-h-[calc(100vh-165px)] flex flex-col justify-center items-center px-4'
		>
			{/* Foto de perfil con animación */}
			<motion.div
				whileHover={{ scale: 1.05 }}
				transition={{ type: 'spring', stiffness: 300 }}
				className='relative w-40 h-40 rounded-full overflow-hidden border-4 border-[#00d9ff] shadow-[0_0_30px_rgba(0,217,255,0.5)] mb-6'
			>
				<video
			...
			<div className='max-w-6xl mx-auto text-center w-full'>
				{/* Nombre y título */}
				<h1 className='text-4xl md:text-4xl text-white glow-text text-center'>
					FEDERICO MATIAS CIOCIANO // FULLSTACK DEVELOPER
				</h1>
				<p className='text-xl text-[#00d9ff] mt-2 font-light text-center'>
			...
			<div className='max-w-6xl mx-auto px-4 pt-7'>
				...
				>
					<p className='text-lg text-[#e4e9f0] leading-relaxed max-w-3xl mx-auto'>
